  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 to-slate-100 p-4 md:p-8">
      <div className="max-w-7xl mx-auto">
        ...
        <p className="text-gray-600 mb-6">Quản lý toàn bộ hóa đơn vận chuyển</p>
        ...
        <DynamicTable
          ...
          columns={[
            ...
            },
            {
              key: "tax",
              title: "Thuế",
              render: (row) => Number(row.tax).toLocaleString("vi-VN") + "đ",
            },
            {
              key: "total_amount",
              title: "Tổng tiền",
