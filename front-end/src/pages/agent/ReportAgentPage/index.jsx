        ...
        <div className="p-6">
          <div className="prose prose-blue max-w-none">
            <p className="text-gray-700 leading-relaxed">
              Báo cáo này cung cấp cái nhìn tổng quan về hoạt động của GoShip
              trong khoảng thời gian đã chọn. Dữ liệu được cập nhật theo thời
              gian thực và có thể được lọc theo nhu cầu của bạn.
            </p>
            <ul className="mt-4 space-y-2 text-gray-700">
              <li className="flex items-start gap-2">
                <div className="w-2 h-2 bg-blue-500 rounded-full mt-2"></div>
                <span>
                  Chọn khoảng thời gian để xem thống kê tổng quan về đơn hàng,
                  khách hàng, doanh thu và dịch vụ.
                </span>
              </li>
              <li className="flex items-start gap-2">
                <div className="w-2 h-2 bg-green-500 rounded-full mt-2"></div>
                <span>
                  Xuất báo cáo ra file Excel hoặc PDF để lưu trữ hoặc chia sẻ
                  với đội ngũ quản lý.
                </span>
              </li>
              <li className="flex items-start gap-2">
                ...
                <span>
                  Sử dụng biểu đồ để phân tích xu hướng và đưa ra quyết định
                  kinh doanh hiệu quả.
                </span>
              </li>
            </ul>
